...
<body>
    <header class="bg-red-700 text-white-300 text-xl min-h-[80px] ">
        <nav class="pt-6">
            <ul class="flex justify-evenly items-center">
                <li><a class="cursor-pointer py-1 px-6 border border-gray-400 border-solid rounded-md hover:bg-blue-400 hover:duration-300" href="index.php">Accueil</a></li>
                <li><a class="cursor-pointer py-1 px-6 border border-gray-400 border-solid rounded-md hover:bg-gray-400 hover:duration-300" href="index.php">Inscription</a></li>
                <li><a class="cursor-pointer py-1 px-6 border border-gray-400 border-solid rounded-md hover:bg-blue-400 hover:duration-300" href="index.php">Connexion</a></li>
                <li><a class="cursor-pointer py-1 px-6 border border-gray-400 border-solid rounded-md hover:bg-gray-400 hover:duration-300" href="index.php">Rechercher</a></li>
            </ul>
        </nav>
    </header>
    ...
    <footer class="bg-green-700 text-blue-300 text-xl min-h-[70px] absolute inset-x-0">
